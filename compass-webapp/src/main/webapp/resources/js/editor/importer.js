...
"use strict";
	COMPASS.Importer = new XML3D.tools.Singleton({
		...
		importAssetAsURL : function(assetName, textFieldId) {
			var assetURL = this._atlasURL() + "rest/asset/" + assetName + "#" + assetName;
		...
		importAssetAsPrefab : function() {
			...
			var assetURL = this._atlasURL() + "rest/asset/" + this.selectedAssetName;
			assetURL = this._forceURLToBeAbsolute(assetURL);
			var data = [{name: "atlasURL", value: this._atlasURL()},
				{name: "assetName", value: this.selectedAssetName}];
